...
class Character:
    ...
    def convert_stats(self):
        self.physical_damage = (
                    self.strength + self.equipped_weapon.strength + self.equipped_armour.strength + self.equipped_token.strength)
        self.magic_damage = (
                    self.intelligence + self.equipped_weapon.intelligence + self.equipped_armour.intelligence + self.equipped_token.intelligence)
        self.max_health = (
                                      self.constitution + self.equipped_weapon.constitution + self.equipped_armour.constitution + self.equipped_token.constitution) * 10 + 100
